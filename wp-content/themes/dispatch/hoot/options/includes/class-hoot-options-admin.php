...
class Hoot_Options_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
			...
			'page_title' => __( 'Theme Options', 'dispatch' ),
			'menu_title' => __( 'Theme Options', 'dispatch' ),
		...
		<div id="hootoptions-box" class="metabox-holder">
			<div id="hootoptions" class="postbox">
				...
				<div id="hootoptions-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'dispatch' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'dispatch' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'dispatch' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'hoot-options', 'restore_defaults', __( 'Default options restored.', 'dispatch' ), 'updated fade' );
	...
	function save_options_notice() {
		...
		if ( !$set )
			add_settings_error( 'hoot-options', 'save_options', __( 'Options saved.', 'dispatch' ), 'updated fade' );
	}
