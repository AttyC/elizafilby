...
$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sUpgrade to Dispatch Premium%2sIf you've enjoyed using Dispatch, you're going to love Dispatch Premium. It's a robust upgrade to Dispatch that gives you useful features.", 'dispatch'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'name' => __('Complete Style Customization', 'dispatch'),
		'desc' => __('Dispatch Premium lets you select different colors for different sections of your site.<hr>Assign different typography (fonts, text size, font color) to menu, topbar, content headings, sidebar, footer etc.', 'dispatch'),
...
$hoot_options_premium[] = array(
		'name' => __('Image Carousals', 'dispatch'),
		'desc' => __('Add carousals to your post, in your sidebar, on your frontpage or in your footer. A simple drag and drop interface allows you to easily create and manage carousals.', 'dispatch'),
...
$hoot_options_premium[] = array(
		...
		'desc' => __('Moving to a new host? Easily import/export your admin panel settings with just a few clicks - right from the backend.', 'dispatch'),
		'img' => 'premium-import-export.jpg',
		);

$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sCustom Javascript &amp; Google Analytics%2sEasily insert any javascript snippet to your header without modifying the code files. This helps in adding scripts for Google Analytics, Adsense or any other custom code.", 'dispatch'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sCustom CSS%2sAdd custom CSS to your theme right from the backend. If you are not a developer yourself, you can count on our support staff to help you with CSS snippets to get the look you're after. Best of all, your changes will persist across theme updates.", 'dispatch'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sContinued Updates%2sYou'll help support the continued development of Dispatch - ensuring it works with future versions of WordPress for years to come.", 'dispatch'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'name' => __('Premium Priority Support', 'dispatch'),
		'desc' => __('Need help setting up Dispatch? Upgrading to Dispatch Premium gives you prioritized forum support. We have a growing support team ready to help you with your questions.', 'dispatch'),
		'img' => 'premium-support.jpg',
		);

$hoot_options_premium[] = array(
		'std' => '<a class="button button-primary button-buy-premium" href="http://wphoot.com/themes/dispatch/" target="_blank">' . __('Buy Now', 'dispatch') . '</a>', );
